...
contract StableCoin is ERC20 {
    ...
    error MinimumDepositError(string message, uint256 minimumDepositAmount);
    ...
    function burn(uint256 burnStableCoinAmount) external {
        int256 deficitOrSurplusInUsd = _get
    ...
    function withdrawCollateralBuffer(uint256 burnDepositorCoinAmount) external {
        require(
            depositorCoin.balanceOf(msg.sender) >= burnDepositorAmount,
